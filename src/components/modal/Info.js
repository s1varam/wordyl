...
export default function Modal(props) {
    ...
    return (
        <>
            {<div className="bg-slate-200 bg-opacity-90 flex justify-center items-center absolute top-0 right-0 bottom-0 left-0 text-sm select-none">
                <div className="bg-white p-4 rounded-md text-center w-10/12 xl:w-96 flex flex-col justify-center items-start">
                    ...
                    <div className="flex justify-center items-center gap-2 mt-4 font-bold">
                    ...
                    <div className="border-t" />
                    <p className="mt-6 font-bold">A new WORDLE will be available each day!</p>
                    <button class="px-4 py-2 rounded-md text-md border-keyAbsent border-solid border mt-4 self-center" onClick={() => props.close()}>CLOSE</button>
                </div>
            </div>}
        </>
    )
