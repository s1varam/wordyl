    ...
    return (
        <>
            {<div className="bg-slate-200 dark:bg-black dark:text-white bg-opacity-90 dark:bg-opacity-90 flex justify-center items-center absolute top-0 right-0 bottom-0 left-0 text-sm select-none z-50">
                <div className="bg-white dark:bg-neutral-900 p-4 opacity-100 rounded-md text-center w-10/12 xl:w-96 flex flex-col justify-center items-center">
                    <div>Made with <FontAwesomeIcon icon={faHeart} className="inline ml-1 mr-1 w-3 h-3 text-red-500" /> using React and Tailwind CSS.</div>
